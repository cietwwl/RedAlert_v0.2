 ...
 * 占领的联盟资源点
 */
public class GuildResCas implements Serializable {
    private static final long serialVersionUID = -5345154348533996685L;
    private int mapCellId;
    private int resCasId;
    private long currentGuildId;    //当前占领联盟Id，未被占领为0
    private String currentGuildName;
    private long firstGuildId;  //首次占领联盟Id，未被占领过为0
