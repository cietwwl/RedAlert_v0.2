...
public class Constant {
	...
	public static String PAY_ID_IOS = "1450001227";

	public static String APP_ID_QQ = "1000001640";
	public static String APP_KEY_QQ = "B0CpjjRg6Zt9eVl6";
	public static String APP_ID_WX = "wx46734908b808f4eb";
	public static String APP_KEY_WX = "8571486180bb4d1725903e7ec3c498a3";
	public static String APP_ID_ITOOLS = "";
	public static String APP_KEY_ITOOLS = "";

	public static final String CASH_ID = "1"; // 元宝
	public static final String CASH_NAME = "元宝"; // 元宝	
	/**
	 * 联运平台的appId与appkey(appsecret)
	 */
	public static String APP_ID_UNION = "";
	public static String APP_KEY_UNION = "";

	/**
	 * facebook平台的Id,key
	 */
	public static String APP_ID_FACEBOOK = "";
	public static String APP_KEY_FACEBOOK = "";
	// 设备类型
	public static final int DEVIDE_TYPE_ANY = 0;
	public static final int DEVIDE_TYPE_ANDROID = 1;
	public static final int DEVIDE_TYPE_IOS = 2;
	public static int DEVIDE_TYPE = DEVIDE_TYPE_ANDROID;

	// 平台类型
	public static final int PLATFORM_TYPE_ANY = 0;
	public static final int PLATFORM_TYPE_QQ = 1;
	public static final int PLATFORM_TYPE_WEIXIN = 2;
	public static final int PLATFORM_TYPE_ITOOLS = 3;
	public static final int PLATFORM_TYPE_VISTOR = 4;// 访客
	public static final int PLATFORM_TYPE_UNION = 5;// 联运
	public static final int PLATFORM_TYPE_FACEBOOK = 6;// facebook	
	
	public static String FACEBOOK_APP_KEY = "9062BFC6F24D73FCC90FE49298E6B8AA";
	// 默认的平台类型
	public static int PLATFORM_TYPE = PLATFORM_TYPE_QQ;
	// 大区ID
	public static String AREA_ID = null;
	//所有分大区的id，格式11,20,23
	public static String ALL_AREA_ID = null;
	// 电脑管家查询接口分配参数
	...
	// public static final String PF_MOBILE_QQ = "mqq";// 手Q
	// public static final String PF_WEIXIN = "weixin";// 微信
	// public static final String PF_VISTOR = "any";// 访客
	...
	public void setQqAppId(String aPPID) {
		if (aPPID == null) {
			return;
		}
		aPPID = aPPID.trim();
	...
	public void setQqAppKey(String aPPKEY) {
		APP_KEY_QQ = aPPKEY;
	}
	...
	public void setUnionAppId(String aPPID) {
		if (aPPID == null) {
			return;
		}
		aPPID = aPPID.trim();
	...
	public void setUnionAppKey(String aPPKEY) {
		APP_KEY_UNION = aPPKEY;
	}

	public void setWxAppKey(String aPPKEY) {
		APP_KEY_WX = aPPKEY;
	}
	...
	public static boolean isTestEnv() {
		// return APP_ID_QQ == null || APP_ID_WX == null;
		return PLATFORM_TYPE == PLATFORM_TYPE_ANY;
	}

	public static String getAppId(int platformType) {

		if (platformType == PLATFORM_TYPE_QQ) {
			return APP_ID_QQ;
		} else if (platformType == PLATFORM_TYPE_WEIXIN) {
			return APP_ID_WX;
		} else if (platformType == PLATFORM_TYPE_ITOOLS) {
			return APP_ID_ITOOLS;
		} else if (platformType == PLATFORM_TYPE_UNION) {
			return APP_ID_UNION;
		} else if (platformType == PLATFORM_TYPE_FACEBOOK) {
			return APP_ID_FACEBOOK;			
		} else if (platformType == PLATFORM_TYPE_VISTOR) {
			if (Constant.PLATFORM_TYPE == Constant.PLATFORM_TYPE_QQ) {
				return APP_ID_QQ;
			} else if (Constant.PLATFORM_TYPE == PLATFORM_TYPE_WEIXIN) {
				return APP_ID_WX;
			} else if (Constant.PLATFORM_TYPE == PLATFORM_TYPE_ITOOLS) {
				return APP_ID_ITOOLS;
			}
		}
		return "";
	...
	public static String getAppId() {
		...
		if (Constant.PLATFORM_TYPE == Constant.PLATFORM_TYPE_QQ) {
			...
			return APP_ID_ITOOLS;
		} else if (Constant.PLATFORM_TYPE == PLATFORM_TYPE_UNION) {
			return APP_ID_UNION;
		} else if (Constant.PLATFORM_TYPE == PLATFORM_TYPE_FACEBOOK) {
			return APP_ID_FACEBOOK;
		}
		return APP_ID_QQ;
	...
	public static boolean isAndroid() {
		return DEVIDE_TYPE == DEVIDE_TYPE_ANDROID;
	}
