...
public class OpenApiV3 {
	public static final Logger log = LoggerFactory.getLogger(OpenApiV3.class);
	 ...
	 * @return 返回服务器响应内容
	 */
	public String api(String scriptName, Map<String, String> params,
			Map<String, String> cookies, String protocol, String method)
...
//		}
		...
		// JsonNode jo = null;
		// try {
		// jo = JSONUtil.getJsonNode(resp);
		// } catch (Exception e) {
		// throw new OpensnsException(ErrorCode.RESPONSE_DATA_INVALID, e);
		// }
		//
		// // 检测ret值
		// int rc = jo.path("ret").getIntValue();

		// 统计上报
		// SnsStat.statReport(startTime, serverName, params, method, protocol,
		// rc,
		// scriptName);
	...
	private void printRequest(String url, String method,
			Map<String, String> params) throws OpensnsException {
		...
		while (iter.hasNext()) {
			...
			try {
				buffer.append(
						...
						.append("=").append(
								URLEncoder.encode(value, "UTF-8").replace("+",
										"%20").replace("*", "%2A")).append("&");
