...
import com.youxigu.dynasty2.openapi.https.MySecureProtocolSocketFactory;
...
public class SnsNetwork {
	public static final Logger log = LoggerFactory.getLogger(SnsNetwork.class);
	...
	public static String postRequest(String url, Map<String, String> params,
		...
		if (cookies != null && !cookies.isEmpty()) {
			Iterator<Map.Entry<String, String>> iter = cookies.entrySet()
					.iterator();
