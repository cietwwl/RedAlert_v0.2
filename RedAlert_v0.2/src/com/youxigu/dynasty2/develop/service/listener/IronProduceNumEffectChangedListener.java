 ...
 *
 */
public class IronProduceNumEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int ironProcNum = castleResService.getIronProducePerQuarter(castle.getUserId(), ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "ironProcNum", ironProcNum);
	}
}
