 ...
 *
 */
public class OilCapacityEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int oilCap = castleResService.getOilCapacity(ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "oilCap", oilCap);
	}
}
