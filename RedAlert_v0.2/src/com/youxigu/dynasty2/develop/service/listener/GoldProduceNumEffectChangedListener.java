 ...
 *
 */
public class GoldProduceNumEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int goldProNum = castleResService.getGoldProducePerQuarter(castle.getUserId(), ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "goldProNum", goldProNum);
	}
}
