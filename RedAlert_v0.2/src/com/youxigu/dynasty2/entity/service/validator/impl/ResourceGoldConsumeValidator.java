 ...
 * 
 */
public class ResourceGoldConsumeValidator extends
	...
	public EntityConsumeResult validate(EntityConsume consume,
		...
		result.setActualNum((int)casRes.getGoldNum());
		return result;
	}
	...
	public EntityConsumeResult validateAndUpdate(EntityConsume consume,
		...
		long realNum = casRes.getGoldNum();
		...
		casRes.setGoldNum(realNum - consumeNum);
