...
JAVA_MEM_OPTS="-Xms2048M -Xmx2560M -Xmn1024M -XX:PermSize=64M -XX:MaxPermSize=128M"
...
;;
mainserver)
JAVA_MEM_OPTS="-Xms1024M -Xmx2048M -Xmn768M -XX:PermSize=64M -XX:MaxPermSize=128M"
...
asyncdbserver)
JAVA_MEM_OPTS="-Xms1024M -Xmx1536M -Xmn512M -XX:PermSize=64M -XX:MaxPermSize=128M"
...
JAVA_OPTS="-server -Djava.net.preferIPv4Stack=true   $JAVA_MEM_OPTS -XX:MaxDirectMemorySize=512M $JAVA_GC_OPTS $JAVA_GCLOG_OPTS"
