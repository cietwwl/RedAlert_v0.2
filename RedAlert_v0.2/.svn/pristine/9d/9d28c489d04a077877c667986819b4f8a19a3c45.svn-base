...
public class DemoSocketClient2 {
	...
	public DemoSocketClient2 mainClient;
	 ...
	 * 宣战
	 */
	public void testDeclare(long userId) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 93009);
		params.put("defUserId", userId);
		params.put("combatDttm", System.currentTimeMillis());
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void testUseStrategy() {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 93006);
		params.put("armyoutId",10503L);
		params.put("troopId", 7);
		params.put("pos",3);
//		params.put("strategyId", Strategy.CHUZHENG);
//		params.put("strategyId", Strategy.WANGMING);
//		params.put("strategyId", Strategy.YINGJI);
//		params.put("strategyId", Strategy.MINGBINLING);
//		params.put("strategyId", Strategy.LUANJIANG);
//		params.put("strategyId", Strategy.CHEHUI);
//		params.put("strategyId", Strategy.JIJIANG);
//		params.put("strategyId", Strategy.QIANXING);
//		params.put("strategyId", Strategy.FANQIAN);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void testInvite() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 93011);
		params.put("toUserId", 59L);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void testView() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 93007);
		params.put("combatDttm", System.currentTimeMillis());
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void doDeportation() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 93010);
		params.put("toUserId", 3615L);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void viewJoin() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24003);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void guildApp() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24005);
		params.put("areaId",1);
		params.put("timeKey","11:50");
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void userApp() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24006);
		params.put("fortressId",1);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void changePos() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24007);
		params.put("fortressId",1);
		params.put("toUserId",6013L);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void enter() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24011);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void pageJoinList() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24004);
		params.put("pageNo", 1);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void userGiveUpApp() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24015);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void addArmy() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24008);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void assistFortress() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24009);
		params.put("fortressId",3);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public void notice() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24010);
		params.put("fortressId",3);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void pageViewFortress() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 24013);
		params.put("fortressId",3);
		params.put("pageNo",1);
		params.put("sid", this.sid);
		this.request(params);
	...
	public void delPassword(String oldPwd) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 23003);
		params.put("oldPwd",oldPwd);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void cheakPassword(String oldPwd) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 23004);
		params.put("oldPwd",oldPwd);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void delItem(long id, int num) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 60007);
		params.put("id",id);
	...
	public void view() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25001);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void calTokenNum() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25002);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void listStar(int parentId) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25003);
		params.put("sid", this.sid);
	...
	public void buyToken() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25004);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void enter2(int sceneId,int parentId) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25005);
	...
	public void viewDispacher() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25006);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void buyRestRate() {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25007);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void fight(int pointId) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25010);
		params.put("pointId",pointId);
		params.put("sid", this.sid);
		this.request(params);
	}
	
	public void move(int pointId) {		
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("cmd", 25009);
		params.put("pointId",pointId);
		params.put("sid", this.sid);
		this.request(params);
	}
	...
	public static void main(String[] args) {
		...
		final DemoSocketClient2[] clients = new DemoSocketClient2[1];
		for (int i = 0; i < clients.length; i++) {
			 clients[i] = startClient("192.168.0.49", 8739, "25",
					 "admin", "123456");
			 try {
				 //抗击匈奴
//				 clients[i].mainClient.viewActivity();
//				 clients[i].mainClient.viewTime();
//				 clients[i].mainClient.viewJoin();
//				 clients[i].mainClient.guildApp();
//				 clients[i].mainClient.userApp();
//				 clients[i].mainClient.userGiveUpApp();
//				 clients[i].mainClient.changePos();
//				 clients[i].mainClient.testLogin(6346+"");
//				 clients[i].mainClient.enter();
//				 clients[i].mainClient.pageJoinList();
//				 clients[i].mainClient.addArmy();
//				 clients[i].mainClient.assistFortress();
//				 clients[i].mainClient.notice();
//				 clients[i].mainClient.pageViewFortress();
				 
				 //出征
//				 clients[i].mainClient.testDeclare(6275L);
//				 clients[i].mainClient.testDeclare(18L);
//				clients[i].mainClient.testFlush();
//				 clients[i].mainClient.testView();
//				 clients[i].mainClient.testGetUser();
//				 clients[i].mainClient.testLogin(31+"");
//				 clients[i].mainClient.testEnter();
//				 clients[i].mainClient.testGiveup();
//				 clients[i].mainClient.testInvite();
//				 clients[i].mainClient.testBuy();
//				clients[i].mainClient.testUseStrategy();				 
//				 clients[i].mainClient.doDeportation();
//				 clients[i].setPassword("1234567");
//				 clients[i].updatePassword("8kslds4","123456");
//				 clients[i].delPassword("1234567");
//				 clients[i].delItem(1673L, 1);
//				 clients[i].cheakPassword("1234567");
				 
//				 clients[i].view();
//				 clients[i].calTokenNum();
//				 clients[i].listStar(1);
//				 clients[i].buyToken();
//				 clients[i].enter2(1,1);
//				 clients[i].viewDispacher();
//				 clients[i].buyRestRate();
				 clients[i].fight(3);
//				 clients[i].move(2);
			} catch (Exception e) {
...
//		for (int i = 0; i < clients.length; i++) {
//
//			clients[i] = startClient("192.168.0.46", 8739, "55",
//					"admin", "123456");
...
//	}
	...
	public static DemoSocketClient2 startClient(final String ip, final int port,
			final String accId, final String usr, final String pwd) {

		// mutiLoginTest();

		final DemoSocketClient2 gameClient = new DemoSocketClient2();
		...
		gameClient.mainClient = new DemoSocketClient2();
...
//		params.put("sid", this.sid);
	...
	public void testUseItem(int id, int num) {
		Map<String, Object> params = new HashMap<String, Object>();
	...
	public Object login() throws Exception {
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("usr", DemoSocketClient2.this.usr);
		params.put("pwd", DemoSocketClient2.this.pwd);
