 ...
 *
 */
public class IronProduceLimitEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int ironProMax = castleResService.getIronProduceLimit(ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "ironProMax", ironProMax);
	}
}
