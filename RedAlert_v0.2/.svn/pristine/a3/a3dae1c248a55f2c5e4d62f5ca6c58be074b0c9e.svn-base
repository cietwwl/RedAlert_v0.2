 ...
 *
 */
public class OilProduceLimitEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int oilProduceMax = castleResService.getOilProduceLimit(ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "oilProduceMax", oilProduceMax);
	}
}
