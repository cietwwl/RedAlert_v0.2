...
JAVA_MEM_OPTS="-Xms512M -Xmx1024M -XX:PermSize=64M -XX:MaxPermSize=128M"
...
mainserver)
LIS_PORT=5001;
JAVA_MEM_OPTS="-Xms256M -Xmx1024M -XX:PermSize=64M -XX:MaxPermSize=128M"
...
JAVA_OPTS="-Dserver.name=$1 -server -Djava.net.preferIPv4Stack=true   $JAVA_MEM_OPTS -XX:MaxDirectMemorySize=512M $JAVA_GC_OPTS $JAVA_GCLOG_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,server=y,address=$LIS_PORT,suspend=n"
