 ...
 * 协议：5个字节协议头+协议体.<br>
 * 协议头1-4字节表示协议长度=协议体长度+1（协议头的标志位）
 * 协议头第5字节为标志字节：<br>
 ...
 *
 */
public class MutilCodecFactory  implements ProtocolCodecFactory{

	private MutliEncoderNew encoder;
	private MutilDecoder decoder;
	
	public MutilCodecFactory(){
		encoder = new MutliEncoderNew();
