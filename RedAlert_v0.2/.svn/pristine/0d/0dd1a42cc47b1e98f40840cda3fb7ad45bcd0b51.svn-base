...
import com.youxigu.dynasty2.openapi.util.Base64Coder;
...
{
	public static final Logger log = LoggerFactory.getLogger(SnsSigCheck.class);
 /** 
  * URL编码 (符合FRC1738规范)
  *
  * @param input 待编码的字符串
 ...
 public static String makeSig1(String method, String url_path, Map<String, String> params, String secret) throws OpensnsException
 {
     String sig = null;
     try
     {
 ...
 public static String makeSource(String method, String url_path, Map<String, String> params) throws OpensnsException
 {
     ...
     String source = buffer2.toString();
     if (log.isDebugEnabled()){
    	 log.debug("参数源串:{}",source);
     }
     buffer.append(encodeUrl(source));

     return buffer.toString();
 }

 public static boolean verifySig(String method, String url_path, Map<String, String> params, String secret, String sig) throws OpensnsException
 {
     // 确保不含sig
     params.remove("sig");
 ...
 public static boolean verifySig1(String method, String url_path, Map<String, String> params, String secret, String sig) throws OpensnsException
 {
     // 确保不含sig
     params.remove("sig");
