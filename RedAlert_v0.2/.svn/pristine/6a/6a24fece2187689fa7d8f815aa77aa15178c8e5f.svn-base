 ...
 * 
 */
public class ResourceUraniumConsumeValidator extends DefaultEntityConsumeValidator {
    ...
    public EntityConsumeResult validate(EntityConsume consume,
        ...
        result.setActualNum((int)casRes.getUranium());
        return result;
    }
    ...
    public EntityConsumeResult validateAndUpdate(EntityConsume consume,
        ...
        long realNum = casRes.getUranium();
        ...
        casRes.setUranium(realNum - consumeNum);
