 ...
 *
 */
public class IronCapacityEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int ironCap = castleResService.getIronCapacity(ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "ironCap", ironCap);
	}
}
