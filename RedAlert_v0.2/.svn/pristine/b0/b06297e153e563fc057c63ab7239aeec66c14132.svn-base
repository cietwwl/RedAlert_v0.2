 ...
 * 
 */
public class ResourceOilConsumeValidator extends DefaultEntityConsumeValidator {
    ...
    public EntityConsumeResult validate(EntityConsume consume,
        ...
        result.setActualNum((int)casRes.getOilNum());
        return result;
    }
    ...
    public EntityConsumeResult validateAndUpdate(EntityConsume consume,
        ...
        casRes.setOilNum(realNum - consumeNum);
