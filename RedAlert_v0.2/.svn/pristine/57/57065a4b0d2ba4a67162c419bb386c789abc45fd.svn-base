 ...
 *
 */
public class GoldProduceLimitEffectChangedListener implements IEffectChangedListener {
	...
	public void effectChanged(Object effect) {
		...
		int goldProMax = castleResService.getGoldProduceLimit(ce.getCasId());
		flushCastleService.sendFlushCasEffEvent(castle.getUserId(), "goldProMax", goldProMax);
	}
}
